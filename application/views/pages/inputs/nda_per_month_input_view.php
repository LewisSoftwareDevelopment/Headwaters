<div class="pageheader">
	<div class="breadcrumb-wrapper">
		...
		<ol class="breadcrumb">
			...
			<li class="active">NDA Per Month Input</li>
		</ol>
	</div>
</div>
<div class="contentpanel">
	<div class="row">
        ...
        <table class= "tablesorter">
            ...
            <tbody>
            <?php
            	foreach($nda_per_month_input as $single_nda_per_month) {  ?>
            	<tr>
					<td><?php echo $single_nda_per_month->ID; ?></td>
    				<td><?php echo $single_nda_per_month->Date; ?></td>
    				<td><?php echo $single_nda_per_month->TotalPerMonth; ?></td>
    			</tr>
