<div class="pageheader">
	<div class="breadcrumb-wrapper">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Referral Company Input</li>
		</ol>
	</div>
</div>
<div class="contentpanel">
	<div class="row">
        ...
        <table class= "tablesorter">
            ...
            <tbody>
            <?php
            	foreach($referral_company_input as $single_referral_company) {  ?>
            	<tr>
					<td><?php echo $single_referral_company->ID; ?></td>
    				<td><?php echo $single_referral_company->Name; ?></td>
    			</tr>
