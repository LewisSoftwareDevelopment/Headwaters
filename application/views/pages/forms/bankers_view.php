					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<input id="YTDLast" class="form-control" type="text" name="YTDLast" maxlength="255" value="<?php echo set_value('YTDLast'); ?>"  />
							...
							<div class="form-group">
								...
								<input id="BudgetYear" class="form-control" type="text" name="BudgetYear" maxlength="255" value="<?php echo set_value('BudgetYear'); ?>"  />
								<?php echo form_error('BudgetYear'); ?>
							</div>

							<div class="form-group">
								<label for="StartDate" class="control-label">Start Date</label>
								<input id="StartDate" class="form-control" type="text" name="StartDate" maxlength="255" value="<?php echo set_value('StartDate'); ?>"  />
								<?php echo form_error('StartDate'); ?>
							</div>

							<div class="form-group">
								<label for="YTDRevenue" class="control-label">YTD Revenue</label>
								<input id="YTDRevenue" class="form-control" type="text" name="YTDRevenue" maxlength="255" value="<?php echo set_value('YTDRevenue'); ?>"  />
								<?php echo form_error('YTDRevenue'); ?>
							</div>

							<div class="form-group">
								<label for="LastYearRev" class="control-label">Last Year Rev</label>
								<input id="LastYearRev" class="form-control" type="text" name="LastYearRev" maxlength="255" value="<?php echo set_value('LastYearRev'); ?>"  />
								<?php echo form_error('LastYearRev'); ?>
							</div>

							<div class="form-group">
								<label for="PriorYearRev" class="control-label">Prior Year Rev</label>
								<input id="PriorYearRev" class="form-control" type="text" name="PriorYearRev" maxlength="255" value="<?php echo set_value('PriorYearRev'); ?>"  />
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							...
							<h3 class="panel-title">Bankers Group 2</h3>
						</div>
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<input id="LastYearRank" class="form-control" type="text" name="LastYearRank" maxlength="255" value="<?php echo set_value('LastYearRank'); ?>"  />
								<?php echo form_error('LastYearRank'); ?>
							</div>

							<div class="form-group">
								<label for="YTDClosing" class="control-label">YTD Closing</label>
								<input id="YTDClosing" class="form-control" type="text" name="YTDClosing" maxlength="255" value="<?php echo set_value('YTDClosing'); ?>"  />
								<?php echo form_error('YTDClosing'); ?>
							</div>

							<div class="form-group">
								<label for="LastYearClosing" class="control-label">Last Year Closing</label>
								<input id="LastYearClosing" class="form-control" type="text" name="LastYearClosing" maxlength="255" value="<?php echo set_value('LastYearClosing'); ?>"  />
								<?php echo form_error('LastYearClosing'); ?>
							</div>

							<div class="form-group">
								<label for="YTDIBC" class="control-label">YTD IBC</label>
								<input id="YTDIBC" class="form-control" type="text" name="YTDIBC" maxlength="255" value="<?php echo set_value('YTDIBC'); ?>"  />
								<?php echo form_error('YTDIBC'); ?>
							</div>

							<div class="form-group">
								<label for="YTDEngagements" class="control-label">YTD Engagements</label>
								<input id="YTDEngagements" class="form-control" type="text" name="YTDEngagements" maxlength="255" value="<?php echo set_value('YTDEngagements'); ?>"  />
								<?php echo form_error('YTDEngagements'); ?>
							</div>

							<div class="form-group">
								<label for="TotalCurrentEngagments" class="control-label">Total Current Engagments</label>
								<input id="TotalCurrentEngagments" class="form-control" type="text" name="TotalCurrentEngagments" maxlength="255" value="<?php echo set_value('TotalCurrentEngagments'); ?>"  />
								<?php echo form_error('TotalCurrentEngagments'); ?>
							</div>

							<div class="form-group">
								<label for="Wheelhouse" class="control-label">Wheelhouse</label>
								<input id="Wheelhouse" class="form-control" type="text" name="Wheelhouse" maxlength="255" value="<?php echo set_value('Wheelhouse'); ?>"  />
								<?php echo form_error('Wheelhouse'); ?>
							</div>

							<div class="form-group">
								<label for="Speculative" class="control-label">Speculative</label>
								<input id="Speculative" class="form-control" type="text" name="Speculative" maxlength="255" value="<?php echo set_value('Speculative'); ?>"  />
								<?php echo form_error('Speculative'); ?>
							</div>

							<div class="form-group">
								<label for="Minimum" class="control-label">Minimum</label>
								<input id="Minimum" class="form-control" type="text" name="Minimum" maxlength="255" value="<?php echo set_value('Minimum'); ?>"  />
							...
							<div class="form-group">
								<?php 
									$attributes = array(
									    ...
									    'id' => 'bankers-button',
									    'value' => 'Add a Bankers record',
									    'type' => 'submit',
									    'content' => 'Add a Bankers record'
									);
