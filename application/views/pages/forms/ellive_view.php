<div class="pageheader">
	<div class="breadcrumb-wrapper">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Ellive Form</li>
		</ol>
	</div>
</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							...
							<h3 class="panel-title">Ellive Group 1</h3>
						</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							...
							<h3 class="panel-title">Ellive Group 2</h3>
						</div>
							...
							<div class="form-group">
								<?php 
									$attributes = array(
									    ...
									    'id' => 'ellive-button',
									    'value' => 'Add an Ellive record',
									    'type' => 'submit',
									    'content' => 'Add an Ellive record'
									);
