<div class="pageheader">
	<div class="breadcrumb-wrapper">
		...
		<ol class="breadcrumb">
			...
			<li class="active">SSVSOP Form</li>
		</ol>
	</div>
</div>
<div class="contentpanel">
	<?php     
		...
		echo form_open('forms/ssvsop_form', $attributes); ?>
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							...
							<h3 class="panel-title">SSVSOP Group 1</h3>
						</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							...
							<h3 class="panel-title">SSVSOP Group 2</h3>
						</div>
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<input id="SS" class="form-control" type="text" name="SS" maxlength="255" value="<?php echo set_value('SS'); ?>"  />
								<?php echo form_error('SS'); ?>
							</div>
							<div class="form-group">
								<label for="Live" class="control-label">Live</label>
								<input id="Live" class="form-control" type="text" name="Live" maxlength="255" value="<?php echo set_value('Live'); ?>"  />
								<?php echo form_error('Live'); ?>
							</div>
							<div class="form-group">
								<label for="Ssovel" class="control-label">SSOVEL</label>
								<input id="Ssovel" class="form-control" type="text" name="Ssovel" maxlength="255" value="<?php echo set_value('Ssovel'); ?>"  />
								<?php echo form_error('Ssovel'); ?>
							</div>
							<div class="form-group">
								<?php 
									$attributes = array(
									    ...
									    'id' => 'ssvsop-button',
									    'value' => 'Add an SSVSOP record',
									    'type' => 'submit',
									    'content' => 'Add an SSVSOP record'
									);
