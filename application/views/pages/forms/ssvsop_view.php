<fieldset><legend>ssvsop_form</legend>
 <?php     
...
<div class="control-group">
	...
	<div class='controls'>
       <input id="SS" type="text" name="SS" maxlength="255" value="<?php echo set_value('SS'); ?>"  />
		 <?php echo form_error('SS'); ?>
	</div>
</div><div class="control-group">
    <label for="Live" class="control-label">Live</label>
	<div class='controls'>
       <input id="Live" type="text" name="Live" maxlength="255" value="<?php echo set_value('Live'); ?>"  />
		 <?php echo form_error('Live'); ?>
	</div>
</div><div class="control-group">
    <label for="Ssovel" class="control-label">SSOVEL</label>
	<div class='controls'>
       <input id="Ssovel" type="text" name="Ssovel" maxlength="255" value="<?php echo set_value('Ssovel'); ?>"  />
