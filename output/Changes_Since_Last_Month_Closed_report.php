...
$layout->blocks["top"][] = "toplinks";$page_layouts["Changes_Since_Last_Month_Closed_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Changes_Since_Last_Month_Closed_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Changes_Since_Last_Month_Closed";
...
if($cross_table)
{
	...
	$cross_array = array();
	$t="Changes_Since_Last_Month_Closed";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Changes_Since_Last_Month_Closed_search.php';return false;\"");
