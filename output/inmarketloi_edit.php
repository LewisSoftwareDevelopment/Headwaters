...
$layout->blocks["top"][] = "details";$page_layouts["inmarketloi_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "inmarketloi_inline_edit.htm" : "inmarketloi_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: inmarketloi_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='inmarketloi_view.php?".$viewlink."'\"");
