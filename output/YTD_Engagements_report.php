...
$layout->blocks["top"][] = "toplinks";$page_layouts["YTD_Engagements_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="YTD_Engagements_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "YTD_Engagements";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='YTD_Engagements_search.php';return false;\"");
