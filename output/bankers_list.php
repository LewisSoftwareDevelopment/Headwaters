...
include_once("include/bankerrev_settings.php");
include_once("include/bankerrank_settings.php");
...
$layout = new TLayout("list4","BoldWhite_label2","MobileWhite_label2");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["bankers_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "YTD+Last";
																			}
...
$viewControls = new ViewControlsContainer(new ProjectSettings("company", PAGE_LIST), PAGE_LIST);
