...
include("include/me_el_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["me_el_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "me_el_inline_edit.htm" : "me_el_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: me_el_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: me_el_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='me_el_view.php?".$viewlink."'\"");
