...
include("include/YTD_Engagements_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["YTD_Engagements_export"] = $layout;
...
$xt->display("YTD_Engagements_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=YTD_Engagements.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=YTD_Engagements.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=YTD_Engagements.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=YTD_Engagements.csv");
