...
$layout->blocks["top"][] = "details";$page_layouts["me_dead_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='me_dead_edit.php?".$editlink."'\"");
