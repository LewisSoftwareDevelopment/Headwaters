...
$layout->blocks["top"][] = "toplinks";$page_layouts["Revenue_Estimates_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Revenue_Estimates_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Revenue_Estimates";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Revenue_Estimates_search.php';return false;\"");
