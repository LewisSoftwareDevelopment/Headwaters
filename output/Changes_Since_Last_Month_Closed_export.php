...
include("include/Changes_Since_Last_Month_Closed_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["Changes_Since_Last_Month_Closed_export"] = $layout;
...
$xt->display("Changes_Since_Last_Month_Closed_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=Changes_Since_Last_Month_Closed.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Changes_Since_Last_Month_Closed.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Changes_Since_Last_Month_Closed.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Changes_Since_Last_Month_Closed.csv");
