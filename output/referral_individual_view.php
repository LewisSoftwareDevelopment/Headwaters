...
$layout->blocks["top"][] = "details";$page_layouts["referral_individual_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='referral_individual_edit.php?".$editlink."'\"");
