...
$layout->blocks["top"][] = "details";$page_layouts["fee_split_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "fee_split_inline_edit.htm" : "fee_split_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: fee_split_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: fee_split_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='fee_split_view.php?".$viewlink."'\"");
