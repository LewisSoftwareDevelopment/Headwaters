...
$layout->blocks["top"][] = "toplinks";$page_layouts["Revenue_Estimates1_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Revenue_Estimates1_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Revenue_Estimates1";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Revenue_Estimates1_search.php';return false;\"");
