...
$layout->blocks["top"][] = "details";$page_layouts["me_el_view"] = $layout;
...
//ELClient - 
	...
	if($mainTableOwnerID=="ELClient")
		$ownerIdValue=$value;
	$xt->assign("ELClient_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='me_el_edit.php?".$editlink."'\"");
