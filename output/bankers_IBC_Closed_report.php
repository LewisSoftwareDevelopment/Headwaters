...
$layout->blocks["top"][] = "toplinks";$page_layouts["bankers_IBC_Closed_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="bankers_IBC_Closed_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "bankers_IBC_Closed";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='bankers_IBC_Closed_search.php';return false;\"");
