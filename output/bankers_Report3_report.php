...
$layout->blocks["top"][] = "toplinks";$page_layouts["bankers_Report3_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="bankers_Report3_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "bankers_Report3";
...
$fieldArr = array();
$fieldArr['name'] = "Year (CURDATE())-3";
//'fName' added for maps
$fieldArr['fName'] = "Year (CURDATE())-3";
$fieldArr['label'] = "Year (CURDATE())-3";
$fieldArr['goodName'] = "Year__CURDATE____3";
$fieldArr['repPage'] = "0";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='bankers_Report3_search.php';return false;\"");
