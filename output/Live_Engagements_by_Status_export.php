...
include("include/Live_Engagements_by_Status_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["Live_Engagements_by_Status_export"] = $layout;
...
$xt->display("Live_Engagements_by_Status_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=Live_Engagements_by_Status.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Live_Engagements_by_Status.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Live_Engagements_by_Status.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Live_Engagements_by_Status.csv");
