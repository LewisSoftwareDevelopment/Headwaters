...
$layout->blocks["top"][] = "toplinks";$page_layouts["bankers_Combo_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="bankers_Combo_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "bankers_Combo";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='bankers_Combo_search.php';return false;\"");
