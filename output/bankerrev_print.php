...
$layout->blocks["top"][] = "pdf";$page_layouts["bankerrev_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Revenue total";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Revenue total");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Name";
...
//	Year - 
			$record["Year_value"] = $pageObject->showDBValue("Year", $data, $keylink);
			$record["Year_class"] = $pageObject->fieldClass("Year");
//	Revenue total - Number
			$record["Revenue_total_value"] = $pageObject->showDBValue("Revenue total", $data, $keylink);
			$record["Revenue_total_class"] = $pageObject->fieldClass("Revenue total");
//	Name - 
...
if($mastertable == "bankers")
{
//	include proper masterprint.php code
	include("include/bankers_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"bankerrev","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_bankers";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["bankers_masterprint"] = $layout;
	...
	$layout = GetPageLayout("bankers", 'masterprint');
	if($layout)
	{
...
$xt->assign("Revenue_total_fieldheadercolumn",true);
$xt->assign("Revenue_total_fieldheader",true);
$xt->assign("Revenue_total_fieldcolumn",true);
$xt->assign("Revenue_total_fieldfootercolumn",true);
