...
$layout = new TLayout("list","BoldWhite_label2","MobileWhite_label2");
...
$layout->skins["recordcontrols"] = "empty";
...
$layout->containers["controlpanel"] = array();

$layout->containers["controlpanel"][] = array("name"=>"tableinfo","block"=>"","substyle"=>1);


$layout->containers["controlpanel"][] = array("name"=>"loggedas","block"=>"security_block","substyle"=>1);


$layout->containers["controlpanel"][] = array("name"=>"toplinks_print","block"=>"prints_block","substyle"=>1);


$layout->containers["controlpanel"][] = array("name"=>"toplinks_advsearch","block"=>"asearch_link","substyle"=>1);


$layout->containers["controlpanel"][] = array("name"=>"toplinks_import","block"=>"import_link","substyle"=>1);


$layout->containers["controlpanel"][] = array("name"=>"toplinks_export","block"=>"export_link","substyle"=>1);




$layout->containers["controlpanel"][] = array("name"=>"quickjump","block"=>"menu_block","substyle"=>1);


$layout->skins["controlpanel"] = "empty";
$layout->blocks["top"][] = "controlpanel";
...
$layout->blocks["top"][] = "search";$page_layouts["bankerrev_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("bankers", PAGE_LIST), PAGE_LIST);
