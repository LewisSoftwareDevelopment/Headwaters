...
include("include/bankers_engagements_YTD_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["bankers_engagements_YTD_export"] = $layout;
...
$xt->display("bankers_engagements_YTD_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=bankers_engagements_YTD.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankers_engagements_YTD.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankers_engagements_YTD.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankers_engagements_YTD.csv");
