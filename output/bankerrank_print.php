...
$layout->blocks["top"][] = "pdf";$page_layouts["bankerrank_print"] = $layout;
...
$arr = array();
$arr['fName'] = "Rank";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Rank");
$fieldsArr[] = $arr;
...
//	Rank - 
			$record["Rank_value"] = $pageObject->showDBValue("Rank", $data, $keylink);
			$record["Rank_class"] = $pageObject->fieldClass("Rank");
			if($col<$colsonpage)
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"bankerrank","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("Rank_fieldheadercolumn",true);
$xt->assign("Rank_fieldheader",true);
$xt->assign("Rank_fieldcolumn",true);
$xt->assign("Rank_fieldfootercolumn",true);
