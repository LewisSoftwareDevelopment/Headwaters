...
$layout->blocks["top"][] = "details";$page_layouts["ssvsop_view"] = $layout;
...
//Sept - 
	...
	if($mainTableOwnerID=="Sept")
		$ownerIdValue=$value;
	$xt->assign("Sept_value",$value);
...
//SS - 
	...
	if($mainTableOwnerID=="SS")
		$ownerIdValue=$value;
	$xt->assign("SS_value",$value);
	if(!$pageObject->isAppearOnTabs("SS"))
		$xt->assign("SS_fieldblock",true);
	else
		$xt->assign("SS_tabfieldblock",true);
////////////////////////////////////////////
//Live - 
	
	$value = $pageObject->showDBValue("Live", $data, $keylink);
	if($mainTableOwnerID=="Live")
		$ownerIdValue=$value;
	$xt->assign("Live_value",$value);
	if(!$pageObject->isAppearOnTabs("Live"))
		$xt->assign("Live_fieldblock",true);
	else
		$xt->assign("Live_tabfieldblock",true);
////////////////////////////////////////////
//ssovel - Number
	
	$value = $pageObject->showDBValue("ssovel", $data, $keylink);
	if($mainTableOwnerID=="ssovel")
		$ownerIdValue=$value;
	$xt->assign("ssovel_value",$value);
	if(!$pageObject->isAppearOnTabs("ssovel"))
		$xt->assign("ssovel_fieldblock",true);
	else
		$xt->assign("ssovel_tabfieldblock",true);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ssvsop_edit.php?".$editlink."'\"");
