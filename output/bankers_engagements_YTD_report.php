...
$layout->blocks["top"][] = "toplinks";$page_layouts["bankers_engagements_YTD_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="bankers_engagements_YTD_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "bankers_engagements_YTD";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='bankers_engagements_YTD_search.php';return false;\"");
