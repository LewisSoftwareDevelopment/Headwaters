...
$layout->blocks["top"][] = "toplinks";$page_layouts["Referral_Utilization_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Referral_Utilization_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Referral_Utilization";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Referral_Utilization_search.php';return false;\"");
