...
$layout->blocks["top"][] = "details";$page_layouts["ellive_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ellive_edit.php?".$editlink."'\"");
