...
$layout->blocks["top"][] = "details";$page_layouts["referral_company_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "referral_company_inline_edit.htm" : "referral_company_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: referral_company_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: referral_company_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='referral_company_view.php?".$viewlink."'\"");
