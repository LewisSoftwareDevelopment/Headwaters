...
include("include/bankerrev_years_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["bankerrev_years_export"] = $layout;
...
$xt->display("bankerrev_years_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=bankerrev_years.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankerrev_years.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankerrev_years.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankerrev_years.csv");
