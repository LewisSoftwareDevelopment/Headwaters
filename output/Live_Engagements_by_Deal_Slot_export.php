...
$layout->blocks["top"][] = "export";$page_layouts["Live_Engagements_by_Deal_Slot_export"] = $layout;
...
$xt->display("Live_Engagements_by_Deal_Slot_export.htm");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Live_Engagements_by_Deal_Slot.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Live_Engagements_by_Deal_Slot.csv");
