...
$strOriginalTableName="`bpengagmentstotal`";
if(!isLogged())
{ 
...
$layout = new TLayout("import","BoldWhite_label2","MobileWhite_label2");
...
$layout->blocks["top"][] = "import";$page_layouts["bpengagmentstotal_import"] = $layout;
...
$xt->display("bpengagmentstotal_import.htm");
