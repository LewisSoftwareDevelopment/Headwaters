...
include_once("include/bankers_settings.php");
include_once("include/referral_company_settings.php");
include_once("include/referral_individual_settings.php");
...
$layout = new TLayout("list42","BoldWhite_label2","MobileWhite_label2");
...
$layout->blocks["left"][] = "searchpanel";
...
$layout->blocks["left"][] = "menu";$layout->blocks["top"] = array();
...
$layout->blocks["top"][] = "toplinks";$page_layouts["company_list"] = $layout;
