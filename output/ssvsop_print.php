...
$layout->blocks["top"][] = "pdf";$page_layouts["ssvsop_print"] = $layout;
...
$arr = array();
$arr['fName'] = "Sept";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Sept");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Oct";
...
$arr = array();
$arr['fName'] = "SS";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("SS");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Live";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Live");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ssovel";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("ssovel");
$fieldsArr[] = $arr;
...
//	Sept - 
			$record["Sept_value"] = $pageObject->showDBValue("Sept", $data, $keylink);
			$record["Sept_class"] = $pageObject->fieldClass("Sept");
//	Oct - 
...
//	SS - 
			$record["SS_value"] = $pageObject->showDBValue("SS", $data, $keylink);
			$record["SS_class"] = $pageObject->fieldClass("SS");
//	Live - 
			$record["Live_value"] = $pageObject->showDBValue("Live", $data, $keylink);
			$record["Live_class"] = $pageObject->fieldClass("Live");
//	ssovel - Number
			$record["ssovel_value"] = $pageObject->showDBValue("ssovel", $data, $keylink);
			$record["ssovel_class"] = $pageObject->fieldClass("ssovel");
			if($col<$colsonpage)
...
$xt->assign("Sept_fieldheadercolumn",true);
$xt->assign("Sept_fieldheader",true);
$xt->assign("Sept_fieldcolumn",true);
$xt->assign("Sept_fieldfootercolumn",true);
...
$xt->assign("SS_fieldheadercolumn",true);
$xt->assign("SS_fieldheader",true);
$xt->assign("SS_fieldcolumn",true);
$xt->assign("SS_fieldfootercolumn",true);
$xt->assign("Live_fieldheadercolumn",true);
$xt->assign("Live_fieldheader",true);
$xt->assign("Live_fieldcolumn",true);
$xt->assign("Live_fieldfootercolumn",true);
$xt->assign("ssovel_fieldheadercolumn",true);
$xt->assign("ssovel_fieldheader",true);
$xt->assign("ssovel_fieldcolumn",true);
$xt->assign("ssovel_fieldfootercolumn",true);
