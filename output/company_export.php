	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo $values["Primary Banker"];//echo htmlspecialchars($values["Primary Banker"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Referral Source-Company"];//echo htmlspecialchars($values["Referral Source-Company"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Referral Scource-Ind."];//echo htmlspecialchars($values["Referral Scource-Ind."]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Team-1"];//echo htmlspecialchars($values["Team-1"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Team-2"];//echo htmlspecialchars($values["Team-2"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Team-3"];//echo htmlspecialchars($values["Team-3"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Team-4"];//echo htmlspecialchars($values["Team-4"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Team-5"];//echo htmlspecialchars($values["Team-5"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Team-6"];//echo htmlspecialchars($values["Team-6"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Fee To-1"];//echo htmlspecialchars($values["Fee To-1"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Fee To-2"];//echo htmlspecialchars($values["Fee To-2"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Fee To-3"];//echo htmlspecialchars($values["Fee To-3"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Fee To-4"];//echo htmlspecialchars($values["Fee To-4"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Fee To-5"];//echo htmlspecialchars($values["Fee To-5"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo $values["Fee To-6"];//echo htmlspecialchars($values["Fee To-6"]); commented for bug #6823
