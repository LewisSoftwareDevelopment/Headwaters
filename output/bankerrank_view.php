...
$layout->blocks["top"][] = "details";$page_layouts["bankerrank_view"] = $layout;
...
//Rank - 
	...
	if($mainTableOwnerID=="Rank")
		$ownerIdValue=$value;
	$xt->assign("Rank_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='bankerrank_edit.php?".$editlink."'\"");
