...
$layout->blocks["top"][] = "toplinks";$page_layouts["Banker_Productivity_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Banker_Productivity_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Banker_Productivity";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Banker_Productivity_search.php';return false;\"");
