...
$layout->blocks["top"][] = "toplinks";$page_layouts["bankerrev_years_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="bankerrev_years_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "bankerrev_years";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='bankerrev_years_search.php';return false;\"");
