...
$layout->blocks["top"][] = "grid";$page_layouts["Changes_Since_Last_Month_rprint"] = $layout;
...
$params["templatefile"] = "Changes_Since_Last_Month_rprint.htm";
$params["xt"] = &$xt;
...
if (@$_REQUEST["format"]=="excel")
{
	...
	header("Content-Disposition: attachment;Filename=Changes_Since_Last_Month.xls");
...
else if (@$_REQUEST["format"]=="word")
{
	...
	header("Content-Disposition: attachment;Filename=Changes_Since_Last_Month.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$fieldArr = array();
$fieldArr['name'] = "CClient";
//'fName' added for maps
$fieldArr['fName'] = "CClient";
$fieldArr['label'] = "CClient";
$fieldArr['goodName'] = "CClient";
$fieldArr['repPage'] = "1";
...
$fieldArr = array();
$fieldArr['name'] = "CDealtype";
//'fName' added for maps
$fieldArr['fName'] = "CDealtype";
$fieldArr['label'] = "CDealtype";
$fieldArr['goodName'] = "CDealtype";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "CAmount";
//'fName' added for maps
$fieldArr['fName'] = "CAmount";
$fieldArr['label'] = "CAmount";
$fieldArr['goodName'] = "CAmount";
$fieldArr['repPage'] = "1";
...
$fieldArr['name'] = "CSlot";
//'fName' added for maps
$fieldArr['fName'] = "CSlot";
$fieldArr['label'] = "CSlot";
$fieldArr['goodName'] = "CSlot";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "DClient";
//'fName' added for maps
$fieldArr['fName'] = "DClient";
$fieldArr['label'] = "DClient";
$fieldArr['goodName'] = "DClient";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$fieldArr['name'] = "DSlot";
//'fName' added for maps
$fieldArr['fName'] = "DSlot";
$fieldArr['label'] = "DSlot";
$fieldArr['goodName'] = "DSlot";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "DAmount";
//'fName' added for maps
$fieldArr['fName'] = "DAmount";
$fieldArr['label'] = "DAmount";
$fieldArr['goodName'] = "DAmount";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "Currency";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "DDealtype";
//'fName' added for maps
$fieldArr['fName'] = "DDealtype";
$fieldArr['label'] = "DDealtype";
$fieldArr['goodName'] = "DDealtype";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "ELClient";
//'fName' added for maps
$fieldArr['fName'] = "ELClient";
$fieldArr['label'] = "ELClient";
$fieldArr['goodName'] = "ELClient";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "ELDealType";
//'fName' added for maps
$fieldArr['fName'] = "ELDealType";
$fieldArr['label'] = "ELDeal Type";
$fieldArr['goodName'] = "ELDealType";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "ELAmount";
//'fName' added for maps
$fieldArr['fName'] = "ELAmount";
$fieldArr['label'] = "ELAmount";
$fieldArr['goodName'] = "ELAmount";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "Currency";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "ELSlot";
//'fName' added for maps
$fieldArr['fName'] = "ELSlot";
$fieldArr['label'] = "ELSlot";
$fieldArr['goodName'] = "ELSlot";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$xt->assign("Deed_fieldheader",true);
$xt->assign("EL_fieldheader",true);
$xt->assign("Live_fieldheader",true);
$xt->assign("LM_fieldheader",true);
