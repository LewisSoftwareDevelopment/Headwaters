...
include("include/me_dead_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["me_dead_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "me_dead_inline_edit.htm" : "me_dead_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: me_dead_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: me_dead_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='me_dead_view.php?".$viewlink."'\"");
