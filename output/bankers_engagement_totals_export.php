...
include("include/bankers_engagement_totals_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["bankers_engagement_totals_export"] = $layout;
...
$xt->display("bankers_engagement_totals_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=bankers_engagement_totals.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankers_engagement_totals.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankers_engagement_totals.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bankers_engagement_totals.csv");
