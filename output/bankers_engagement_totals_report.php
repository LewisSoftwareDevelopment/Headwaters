...
$layout->blocks["top"][] = "toplinks";$page_layouts["bankers_engagement_totals_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="bankers_engagement_totals_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "bankers_engagement_totals";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='bankers_engagement_totals_search.php';return false;\"");
