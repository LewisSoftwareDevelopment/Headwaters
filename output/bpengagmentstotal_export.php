...
$layout->blocks["top"][] = "export";$page_layouts["bpengagmentstotal_export"] = $layout;
...
$xt->display("bpengagmentstotal_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=bpengagmentstotal.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bpengagmentstotal.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bpengagmentstotal.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=bpengagmentstotal.csv");
