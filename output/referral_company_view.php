...
$layout->blocks["top"][] = "details";$page_layouts["referral_company_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='referral_company_edit.php?".$editlink."'\"");
