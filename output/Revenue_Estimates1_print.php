...
$layout->blocks["top"][] = "grid";$page_layouts["Revenue_Estimates1_rprint"] = $layout;
...
$params["templatefile"] = "Revenue_Estimates1_rprint.htm";
$params["xt"] = &$xt;
...
$groupField = array();
$groupField['strGroupField'] = "Pipeline";
...
$fieldArr = array();
$fieldArr['name'] = "Pipeline";
//'fName' added for maps
$fieldArr['fName'] = "Pipeline";
$fieldArr['label'] = "Pipeline";
$fieldArr['goodName'] = "Pipeline";
$fieldArr['repPage'] = "1";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "This Year Buget Gross";
//'fName' added for maps
$fieldArr['fName'] = "This Year Buget Gross";
$fieldArr['label'] = "This Year Buget Gross";
$fieldArr['goodName'] = "This_Year_Buget_Gross";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "This Year Budget Net";
//'fName' added for maps
$fieldArr['fName'] = "This Year Budget Net";
$fieldArr['label'] = "This Year Budget Net";
$fieldArr['goodName'] = "This_Year_Budget_Net";
$fieldArr['repPage'] = "1";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "YTD Net Actual";
//'fName' added for maps
$fieldArr['fName'] = "YTD Net Actual";
$fieldArr['label'] = "YTD Net Actual";
$fieldArr['goodName'] = "YTD_Net_Actual";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "Currency";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
...
else
{
	$rb = new Report(array($gQuery->HeadToSql(), $gQuery->FromToSql(), $strWhereClause, $gQuery->GroupByToSql(), $gQuery->HavingToSql())
		, $pageObject->pSet->GetTableData(".orderindexes"), $pageObject->searchClauseObj, $conn, $PageSize, 20, $params, $pageObject);
...
$xt->assign("This_Year_Buget_Gross_fieldheader",true);
$xt->assign("This_Year_Budget_Net_fieldheader",true);
$xt->assign("YTD_Net_Actual_fieldheader",true);
