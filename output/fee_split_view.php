...
$layout->blocks["top"][] = "details";$page_layouts["fee_split_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='fee_split_edit.php?".$editlink."'\"");
