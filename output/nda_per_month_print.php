...
$layout->blocks["top"][] = "pdf";$page_layouts["nda_per_month_print"] = $layout;
...
//	Total per Month - 
			$record["Total_per_Month_value"] = $pageObject->showDBValue("Total per Month", $data, $keylink);
			$record["Total_per_Month_class"] = $pageObject->fieldClass("Total per Month");
			if($col<$colsonpage)
...
$xt->assign("Total_per_Month_fieldheadercolumn",true);
$xt->assign("Total_per_Month_fieldheader",true);
$xt->assign("Total_per_Month_fieldcolumn",true);
$xt->assign("Total_per_Month_fieldfootercolumn",true);
