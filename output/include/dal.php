...
class tDAL
{
	...
	var $bankerrank;
	var $fee_split;
	var $referral_company;
	var $referral_individual;
	var $bprevstore;
	var $bpengagements;
	var $bpengagmentstotal;
	var $changes_last_month_end;
	var $me_el;
	var $me_dead;
	var $me_close;
	var $me_totals;
	var $nda_per_month;
	var $utilization_targets;
	var $actuals;
	var $ellive;
	var $inmarketloi;
	var $ssvsop;
	...
	function FillTablesList()
	{
	  ...
	  $this->lstTables[]=array("name"=>"bankers","varname"=>"bankers");
	  $this->lstTables[]=array("name"=>"bankerrev","varname"=>"bankerrev");
	  $this->lstTables[]=array("name"=>"bankerrank","varname"=>"bankerrank");
	  $this->lstTables[]=array("name"=>"fee split","varname"=>"fee_split");
	  $this->lstTables[]=array("name"=>"referral company","varname"=>"referral_company");
	  $this->lstTables[]=array("name"=>"referral individual","varname"=>"referral_individual");
	  $this->lstTables[]=array("name"=>"bprevstore","varname"=>"bprevstore");
	  $this->lstTables[]=array("name"=>"bpengagements","varname"=>"bpengagements");
	  $this->lstTables[]=array("name"=>"bpengagmentstotal","varname"=>"bpengagmentstotal");
	  $this->lstTables[]=array("name"=>"changes last month end","varname"=>"changes_last_month_end");
	  $this->lstTables[]=array("name"=>"me-el","varname"=>"me_el");
	  $this->lstTables[]=array("name"=>"me-dead","varname"=>"me_dead");
	  $this->lstTables[]=array("name"=>"me-close","varname"=>"me_close");
	  $this->lstTables[]=array("name"=>"me-totals","varname"=>"me_totals");
	  $this->lstTables[]=array("name"=>"nda per month","varname"=>"nda_per_month");
	  $this->lstTables[]=array("name"=>"utilization targets","varname"=>"utilization_targets");
	  $this->lstTables[]=array("name"=>"actuals","varname"=>"actuals");
	  $this->lstTables[]=array("name"=>"ellive","varname"=>"ellive");
	  $this->lstTables[]=array("name"=>"inmarketloi","varname"=>"inmarketloi");
	  $this->lstTables[]=array("name"=>"ssvsop","varname"=>"ssvsop");
