...
$layout->blocks["top"][] = "toplinks";$page_layouts["Live_Engagements_by_Status_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Live_Engagements_by_Status_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Live_Engagements_by_Status";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Live_Engagements_by_Status_search.php';return false;\"");
