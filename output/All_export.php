...
$layout->blocks["top"][] = "export";$page_layouts["All_export"] = $layout;
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=All.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=All.xml");
