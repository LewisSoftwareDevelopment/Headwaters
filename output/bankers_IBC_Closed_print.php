...
$layout->blocks["top"][] = "grid";$page_layouts["bankers_IBC_Closed_rprint"] = $layout;
...
$params["templatefile"] = "bankers_IBC_Closed_rprint.htm";
$params["xt"] = &$xt;
...
$xt->assign("Rows_fieldheader",true);
$xt->assign("Primary_Banker_fieldheader",true);
$xt->assign("company_Count_fieldheader",true);
