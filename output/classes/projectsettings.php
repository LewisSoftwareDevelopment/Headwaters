...
function GetTableURL($table = "")
{
	...
	if("bankers" == $table) 
		return "bankers";
	if("bankers engagements YTD" == $table) 
		return "bankers_engagements_YTD";
	if("bankerrev" == $table) 
		return "bankerrev";
	if("bankerrank" == $table) 
		return "bankerrank";
	if("fee split" == $table) 
		return "fee_split";
	if("referral company" == $table) 
		return "referral_company";
	if("referral individual" == $table) 
		return "referral_individual";
	if("bankers Combo" == $table) 
		return "bankers_Combo";
	if("bankers Report3" == $table) 
		return "bankers_Report3";
	if("bankerrev years" == $table) 
		return "bankerrev_years";
	if("company Report" == $table) 
		return "company_Report";
	if("bankers IBC/Closed" == $table) 
		return "bankers_IBC_Closed";
	if("All" == $table) 
		return "All";
	if("bprevstore" == $table) 
		return "bprevstore";
	if("bpengagements" == $table) 
		return "bpengagements";
	if("Banker Productivity" == $table) 
		return "Banker_Productivity";
	if("bpengagmentstotal" == $table) 
		return "bpengagmentstotal";
	if("bankers engagement totals" == $table) 
		return "bankers_engagement_totals";
	if("Live Engagements by Deal Slot" == $table) 
		return "Live_Engagements_by_Deal_Slot";
	if("Live Sell-Side Engagements by Enterprise Value" == $table) 
		return "Live_Sell_Side_Engagements_by_Enterprise_Value";
	if("YTD Engagements" == $table) 
		return "YTD_Engagements";
	if("Live Engagements by Status" == $table) 
		return "Live_Engagements_by_Status";
	if("Referral Utilization" == $table) 
		return "Referral_Utilization";
	if("Snapshot" == $table) 
		return "Snapshot";
	if("Changes Since Last Month-EL" == $table) 
		return "Changes_Since_Last_Month_EL";
	if("Changes Since Last Month-Dead" == $table) 
		return "Changes_Since_Last_Month_Dead";
	if("Changes Since Last Month-Closed" == $table) 
		return "Changes_Since_Last_Month_Closed";
	if("changes last month end" == $table) 
		return "changes_last_month_end";
	if("bankerrank Chart" == $table) 
		return "bankerrank_Chart";
	if("me-el" == $table) 
		return "me_el";
	if("me-dead" == $table) 
		return "me_dead";
	if("me-close" == $table) 
		return "me_close";
	if("Changes Since Last Month" == $table) 
		return "Changes_Since_Last_Month";
	if("me-totals" == $table) 
		return "me_totals";
	if("nda per month" == $table) 
		return "nda_per_month";
	if("utilization targets" == $table) 
		return "utilization_targets";
	if("Revenue Estimates1" == $table) 
		return "Revenue_Estimates1";
	if("actuals" == $table) 
		return "actuals";
	if("ellive" == $table) 
		return "ellive";
	if("inmarketloi" == $table) 
		return "inmarketloi";
	if("ssvsop" == $table) 
		return "ssvsop";
	if("Trend Analysis LTM" == $table) 
		return "Trend_Analysis_LTM";
}
...
{	
	...
	if("company" == $shortTName) 
		return "company";
	if("bankers" == $shortTName) 
		return "bankers";
	if("bankers_engagements_YTD" == $shortTName) 
		return "bankers engagements YTD";
	if("bankerrev" == $shortTName) 
		return "bankerrev";
	if("bankerrank" == $shortTName) 
		return "bankerrank";
	if("fee_split" == $shortTName) 
		return "fee split";
	if("referral_company" == $shortTName) 
		return "referral company";
	if("referral_individual" == $shortTName) 
		return "referral individual";
	if("bankers_Combo" == $shortTName) 
		return "bankers Combo";
	if("bankers_Report3" == $shortTName) 
		return "bankers Report3";
	if("bankerrev_years" == $shortTName) 
		return "bankerrev years";
	if("company_Report" == $shortTName) 
		return "company Report";
	if("bankers_IBC_Closed" == $shortTName) 
		return "bankers IBC/Closed";
	if("All" == $shortTName) 
		return "All";
	if("bprevstore" == $shortTName) 
		return "bprevstore";
	if("bpengagements" == $shortTName) 
		return "bpengagements";
	if("Banker_Productivity" == $shortTName) 
		return "Banker Productivity";
	if("bpengagmentstotal" == $shortTName) 
		return "bpengagmentstotal";
	if("bankers_engagement_totals" == $shortTName) 
		return "bankers engagement totals";
	if("Live_Engagements_by_Deal_Slot" == $shortTName) 
		return "Live Engagements by Deal Slot";
	if("Live_Sell_Side_Engagements_by_Enterprise_Value" == $shortTName) 
		return "Live Sell-Side Engagements by Enterprise Value";
	if("YTD_Engagements" == $shortTName) 
		return "YTD Engagements";
	if("Live_Engagements_by_Status" == $shortTName) 
		return "Live Engagements by Status";
	if("Referral_Utilization" == $shortTName) 
		return "Referral Utilization";
	if("Snapshot" == $shortTName) 
		return "Snapshot";
	if("Changes_Since_Last_Month_EL" == $shortTName) 
		return "Changes Since Last Month-EL";
	if("Changes_Since_Last_Month_Dead" == $shortTName) 
		return "Changes Since Last Month-Dead";
	if("Changes_Since_Last_Month_Closed" == $shortTName) 
		return "Changes Since Last Month-Closed";
	if("changes_last_month_end" == $shortTName) 
		return "changes last month end";
	if("bankerrank_Chart" == $shortTName) 
		return "bankerrank Chart";
	if("me_el" == $shortTName) 
		return "me-el";
	if("me_dead" == $shortTName) 
		return "me-dead";
	if("me_close" == $shortTName) 
		return "me-close";
	if("Changes_Since_Last_Month" == $shortTName) 
		return "Changes Since Last Month";
	if("me_totals" == $shortTName) 
		return "me-totals";
	if("nda_per_month" == $shortTName) 
		return "nda per month";
	if("utilization_targets" == $shortTName) 
		return "utilization targets";
	if("Revenue_Estimates1" == $shortTName) 
		return "Revenue Estimates1";
	if("actuals" == $shortTName) 
		return "actuals";
	if("ellive" == $shortTName) 
		return "ellive";
	if("inmarketloi" == $shortTName) 
		return "inmarketloi";
	if("ssvsop" == $shortTName) 
		return "ssvsop";
	if("Trend_Analysis_LTM" == $shortTName) 
		return "Trend Analysis LTM";
}
