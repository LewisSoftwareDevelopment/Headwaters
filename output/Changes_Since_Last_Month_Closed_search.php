...
$layout->blocks["top"][] = "search";$page_layouts["Changes_Since_Last_Month_Closed_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "Changes_Since_Last_Month_Closed_search.htm";
...
$params['shortTableName'] = 'Changes_Since_Last_Month_Closed';
