...
$layout->blocks["top"][] = "toplinks";$page_layouts["Trend_Analysis_LTM_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Trend_Analysis_LTM_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Trend_Analysis_LTM";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "company Count";
//'fName' added for maps
$fieldArr['fName'] = "company Count";
$fieldArr['label'] = "Company Count";
$fieldArr['goodName'] = "company_Count";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "CorpPrac";
//'fName' added for maps
$fieldArr['fName'] = "CorpPrac";
$fieldArr['label'] = "Corp Prac";
$fieldArr['goodName'] = "CorpPrac";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "Number";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "el from";
//'fName' added for maps
$fieldArr['fName'] = "el from";
$fieldArr['label'] = "El From";
$fieldArr['goodName'] = "el_from";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "Number";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "LiveEL";
//'fName' added for maps
$fieldArr['fName'] = "LiveEL";
$fieldArr['label'] = "Live EL";
$fieldArr['goodName'] = "LiveEL";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "Number";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Trend_Analysis_LTM_search.php';return false;\"");
