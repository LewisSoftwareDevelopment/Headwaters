...
$layout->blocks["top"][] = "toplinks";$page_layouts["Live_Sell_Side_Engagements_by_Enterprise_Value_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Live_Sell_Side_Engagements_by_Enterprise_Value_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Live_Sell_Side_Engagements_by_Enterprise_Value";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Vertical";
//'fName' added for maps
$fieldArr['fName'] = "Vertical";
$fieldArr['label'] = "Vertical";
$fieldArr['goodName'] = "Vertical";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
if($cross_table)
{
	...
	$cross_array = array();
	$t="Live_Sell_Side_Engagements_by_Enterprise_Value";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Live_Sell_Side_Engagements_by_Enterprise_Value_search.php';return false;\"");
